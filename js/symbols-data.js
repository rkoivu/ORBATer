...
const UT=[
  ...
  {cat:'Combat',subcat:'Infantry',id:'marines',label:'Marines',icon:c=>`<image href="assets/icons/types/infantry/amphibious_infantry.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Combat',subcat:'Infantry',id:'naval_infantry',label:'Naval Infantry',icon:c=>`<image href="assets/icons/types/infantry/amphibious_infantry.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Special Forces',subcat:'Special Forces',id:'marine_raiders',label:'Marine Raiders',icon:c=>`<image href="assets/icons/types/special_forces/special_forces.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Combat',subcat:'Infantry',id:'glider_infantry',label:'Glider & Airlanding Infantry',icon:c=>`<path d="M7,18 Q18,9 27,13 Q36,17 43,14" fill="none" stroke="${c.stroke}" stroke-width="2"/><path d="M24,12 L24,23" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M17,17 L31,17" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
  {cat:'Combat',subcat:'Infantry',id:'bicycle_infantry',label:'Bicycle Infantry',icon:c=>`<circle cx="16" cy="23" r="4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="34" cy="23" r="4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M16,23 L23,16 L28,23 L34,23 L23,16" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M6,6 L46,26 M46,6 L6,26" stroke="${c.stroke}" stroke-width="2"/>`},
  {cat:'Combat',subcat:'Infantry',id:'machine_gun',label:'Machine Gun',icon:c=>`<line x1="10" y1="23" x2="34" y2="23" stroke="${c.stroke}" stroke-width="2"/><line x1="18" y1="23" x2="14" y2="28" stroke="${c.stroke}" stroke-width="1.8"/><line x1="24" y1="23" x2="20" y2="28" stroke="${c.stroke}" stroke-width="1.8"/><line x1="30" y1="23" x2="26" y2="28" stroke="${c.stroke}" stroke-width="1.8"/><line x1="34" y1="22" x2="42" y2="18" stroke="${c.stroke}" stroke-width="2"/>`},
  {cat:'Combat',subcat:'Infantry',id:'mech_inf_tracked_ifv',label:'Mechanised Infantry (Tracked IFVs)',icon:c=>`<image href="assets/icons/types/infantry/mechanised_infantry_tracked_ifv.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Combat',subcat:'Infantry',id:'mech_inf_wheeled_ifv',label:'Mechanised Infantry (Wheeled IFVs)',icon:c=>`<image href="assets/icons/types/infantry/mechanised_infantry_wheeled_ifv.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Combat',subcat:'Infantry',id:'wheeled_mech_inf',label:'Wheeled Mechanised Infantry',icon:c=>`<image href="assets/icons/types/infantry/wheeled_mechanised_infantry.svg" x="0" y="0" width="50" height="30"/>`},
  // COMBAT - ARMOUR
  ...
  {cat:'Combat',subcat:'Armour',id:'light_armour',label:'Light Armour',icon:c=>`<image href="assets/icons/types/armour/light_armour.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Combat',subcat:'Armour',id:'tank_destroyers',label:'Tank Destroyers',icon:c=>`<image href="assets/icons/types/armour/tank_destroyer.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Combat',subcat:'Armour',id:'armoured_car',label:'Armoured Car',icon:c=>`<path d="M11,16 h22 a4,4 0 0 1 4,4 v2 h-26 a4,4 0 0 1 0,-6 z" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="16" cy="25" r="2.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="32" cy="25" r="2.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
  ...
  {cat:'Combat',subcat:'Armour',id:'cavalry_recon',label:'Cavalry Reconnaissance',icon:c=>`<path d="M45,5 L5,25" stroke="${c.stroke}" stroke-width="2.2"/><path d="M12,24 q5,-8 10,0 q5,-8 10,0" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="16" cy="15" r="2" fill="none" stroke="${c.stroke}" stroke-width="1.5"/>`},
  {cat:'Combat',subcat:'Armour',id:'recce_motorcycle',label:'Recce Motorcycle',icon:c=>`<circle cx="16" cy="23" r="3.8" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="34" cy="23" r="3.8" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M16,23 L23,17 L28,23 L34,23" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="23" y1="17" x2="27" y2="13" stroke="${c.stroke}" stroke-width="1.8"/>`},
  ...
  {cat:'Combat',subcat:'Armour',id:'wheeled_armoured_recon',label:'Wheeled Armoured Reconnaissance',icon:c=>`<path d="M45,5 L5,25" stroke="${c.stroke}" stroke-width="2.2"/><path d="M11,15 h28 a4,4 0 0 1 0,8 h-28 a4,4 0 0 1 0,-8 z" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="16" cy="25" r="2.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="34" cy="25" r="2.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
  {cat:'Combat',subcat:'Armour',id:'half_tracks',label:'Half-Tracks',icon:c=>`<path d="M10,15 h22 a4,4 0 0 1 4,4 v3 h-26 a4,4 0 0 1 0,-7 z" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="16" cy="25" r="2.4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="24" y1="25" x2="39" y2="25" stroke="${c.stroke}" stroke-width="2"/><circle cx="28" cy="25" r="1.8" fill="${c.stroke}"/><circle cx="35" cy="25" r="1.8" fill="${c.stroke}"/>`},
  // FIRES - ARTILLERY
  ...
  {cat:'Fires',subcat:'Artillery',id:'field_artillery',label:'Field Artillery',icon:c=>`<line x1="11" y1="24" x2="31" y2="24" stroke="${c.stroke}" stroke-width="2"/><circle cx="15" cy="24" r="2.3" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="27" cy="24" r="2.3" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="31" y1="22" x2="42" y2="17" stroke="${c.stroke}" stroke-width="2"/>`},
  {cat:'Fires',subcat:'Artillery',id:'heavy_artillery',label:'Heavy Artillery',icon:c=>`<line x1="9" y1="24" x2="30" y2="24" stroke="${c.stroke}" stroke-width="2.2"/><circle cx="14" cy="24" r="2.7" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="26" cy="24" r="2.7" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="30" y1="21" x2="43" y2="15" stroke="${c.stroke}" stroke-width="2.4"/>`},
  {cat:'Fires',subcat:'Artillery',id:'super_heavy_artillery',label:'Super-Heavy Artillery',icon:c=>`<rect x="9" y="19" width="18" height="5" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="27" y1="20" x2="44" y2="13" stroke="${c.stroke}" stroke-width="2.6"/><line x1="10" y1="26" x2="28" y2="26" stroke="${c.stroke}" stroke-width="2"/><circle cx="14" cy="26" r="1.8" fill="${c.stroke}"/><circle cx="21" cy="26" r="1.8" fill="${c.stroke}"/>`},
  {cat:'Fires',subcat:'Artillery',id:'railway_artillery',label:'Railway Artillery',icon:c=>`<line x1="7" y1="27" x2="43" y2="27" stroke="${c.stroke}" stroke-width="2"/><line x1="10" y1="23" x2="30" y2="23" stroke="${c.stroke}" stroke-width="2"/><line x1="30" y1="22" x2="42" y2="16" stroke="${c.stroke}" stroke-width="2.2"/><circle cx="13" cy="27" r="1.6" fill="${c.stroke}"/><circle cx="21" cy="27" r="1.6" fill="${c.stroke}"/><circle cx="29" cy="27" r="1.6" fill="${c.stroke}"/><circle cx="37" cy="27" r="1.6" fill="${c.stroke}"/>`},
  ...
  {cat:'Fires',subcat:'Artillery',id:'rocket_mortar',label:'Rocket Mortar',icon:c=>`<path d="M11,24 H31" fill="none" stroke="${c.stroke}" stroke-width="2"/><line x1="15" y1="19" x2="28" y2="19" stroke="${c.stroke}" stroke-width="1.8"/><line x1="28" y1="19" x2="41" y2="14" stroke="${c.stroke}" stroke-width="2"/><path d="M40,14 l3,1 l-2,3" fill="none" stroke="${c.stroke}" stroke-width="1.6"/>`},
  ...
  {cat:'Fires',subcat:'Artillery',id:'anti_aircraft_artillery',label:'Anti-Aircraft Artillery',icon:c=>`<line x1="25" y1="6" x2="25" y2="19" stroke="${c.stroke}" stroke-width="2"/><line x1="18" y1="10" x2="32" y2="10" stroke="${c.stroke}" stroke-width="2"/><line x1="20" y1="14" x2="30" y2="14" stroke="${c.stroke}" stroke-width="2"/><line x1="11" y1="24" x2="31" y2="24" stroke="${c.stroke}" stroke-width="2"/><circle cx="15" cy="24" r="2.3" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="27" cy="24" r="2.3" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
  ...
  {cat:'Fires',subcat:'Artillery',id:'coastal_artillery',label:'Coastal Artillery',icon:c=>`<line x1="8" y1="26" x2="26" y2="26" stroke="${c.stroke}" stroke-width="2"/><path d="M26,24 L43,16" fill="none" stroke="${c.stroke}" stroke-width="2.2"/><path d="M8,20 q4,3 8,0 q4,-3 8,0" fill="none" stroke="${c.stroke}" stroke-width="1.6"/>`},
  ...
  {cat:'Fires',subcat:'Other Fires',id:'shorad',label:'Short-Range Air Defence',icon:c=>`<image href="assets/icons/types/artillery/air_defence_missiles.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Fires',subcat:'Other Fires',id:'manpads',label:'MANPADS',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">MANPAD</text>`},
  {cat:'Fires',subcat:'Other Fires',id:'sam_long_range',label:'Long-Range SAM',icon:c=>`<image href="assets/icons/types/artillery/air_defence_missiles.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Fires',subcat:'Other Fires',id:'wheeled_anti_tank',label:'Wheeled Anti-Tank',icon:c=>`<image href="assets/icons/types/artillery/wheeled_anti-tank.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Fires',subcat:'Other Fires',id:'self_propelled_aaa',label:'Self-Propelled Anti-Aircraft Artillery',icon:c=>`<line x1="25" y1="6" x2="25" y2="20" stroke="${c.stroke}" stroke-width="2"/><line x1="18" y1="10" x2="32" y2="10" stroke="${c.stroke}" stroke-width="2"/><line x1="20" y1="14" x2="30" y2="14" stroke="${c.stroke}" stroke-width="2"/><rect x="11" y="20" width="28" height="4.5" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="8" y1="26" x2="42" y2="26" stroke="${c.stroke}" stroke-width="2"/><circle cx="14" cy="26" r="1.8" fill="${c.stroke}"/><circle cx="22" cy="26" r="1.8" fill="${c.stroke}"/><circle cx="30" cy="26" r="1.8" fill="${c.stroke}"/><circle cx="38" cy="26" r="1.8" fill="${c.stroke}"/>`},
  {cat:'Fires',subcat:'Other Fires',id:'infantry_assault_guns',label:'Infantry Guns / Assault Guns',icon:c=>`<rect x="10" y="18" width="18" height="6" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="28" y1="20" x2="41" y2="16" stroke="${c.stroke}" stroke-width="2"/><line x1="12" y1="25" x2="31" y2="25" stroke="${c.stroke}" stroke-width="2"/><text x="38" y="24" text-anchor="middle" font-size="7" font-weight="bold" fill="${c.stroke}">IG</text>`},
  ...
  {cat:'Fires',subcat:'Other Fires',id:'electronic_attack',label:'Electronic Attack',icon:c=>`<image href="assets/icons/types/support/electronic_warfare.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Fires',subcat:'Other Fires',id:'target_acquisition',label:'Target Acquisition',icon:c=>`<image href="assets/icons/types/artillery/artillery_reconnaissance.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Fires',subcat:'Other Fires',id:'counter_battery_radar',label:'Counter-Battery Radar',icon:c=>`<image href="assets/icons/types/support/radar.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Fires',subcat:'Other Fires',id:'loitering_munitions',label:'Loitering Munitions',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">LM</text>`},
  // SUPPORT - ENGINEERS
  ...
  {cat:'Support',subcat:'Engineers',id:'pioneers',label:'Pioneers',icon:c=>`<image href="assets/icons/types/engineers/engineers.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Engineers',id:'mobility_support',label:'Mobility Support',icon:c=>`<image href="assets/icons/types/engineers/engineers.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Engineers',id:'route_clearance',label:'Route Clearance',icon:c=>`<image href="assets/icons/types/engineers/reconnaissance_engineers.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Engineers',id:'construction_engineers',label:'Construction Engineers',icon:c=>`<image href="assets/icons/types/engineers/construction_engineers.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Engineers',id:'air_defense_engineers',label:'Airfield / Air Defence Engineers',icon:c=>`<image href="assets/icons/types/engineers/construction_engineers.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Engineers',id:'railway_troops',label:'Railway Troops',icon:c=>`<image href="assets/icons/types/engineers/engineers.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Communications',id:'signals_intelligence',label:'Signals Intelligence',icon:c=>`<image href="assets/icons/types/support/signals.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Intelligence',id:'intel',label:'Intelligence',icon:c=>`<image href="assets/icons/types/support/intelligence.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Intelligence',id:'geospatial_intelligence',label:'GEOINT',icon:c=>`<image href="assets/icons/types/support/intelligence.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Intelligence',id:'surveillance',label:'Surveillance',icon:c=>`<image href="assets/icons/types/support/intelligence.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Logistics',id:'movement_control',label:'Movement Control',icon:c=>`<image href="assets/icons/types/service_support/transport.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Logistics',id:'ammunition',label:'Ammunition',icon:c=>`<image href="assets/icons/types/support/ammunition.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Logistics',id:'water_supply',label:'Water Supply',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="${c.stroke}">H2O</text>`},
  {cat:'Support',subcat:'Logistics',id:'pipeline',label:'Pipeline / Bulk Fuel Distribution',icon:c=>`<image href="assets/icons/types/support/fuel.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Logistics',id:'ordnance',label:'Ordnance',icon:c=>`<image href="assets/icons/types/service_support/ordnance.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Logistics',id:'laundry_sanitation',label:'Laundry & Sanitation',icon:c=>`<image href="assets/icons/types/service_support/laundry_sanitation.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Logistics',id:'postal',label:'Postal',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="${c.stroke}">POST</text>`},
  {cat:'Support',subcat:'Logistics',id:'replacement',label:'Personnel Replacement',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">PERS</text>`},
  {cat:'Support',subcat:'Logistics',id:'replacement_pool',label:'Replacement Pool',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">POOL</text>`},
  ...
  {cat:'Support',subcat:'Medical',id:'medevac',label:'MEDEVAC',icon:c=>`<image href="assets/icons/types/service_support/medical.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Medical',id:'field_hospital',label:'Field Hospital',icon:c=>`<rect x="11" y="12" width="28" height="14" rx="2" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M25,14 v10 M20,19 h10" stroke="${c.stroke}" stroke-width="2"/>`},
  ...
  {cat:'Support',subcat:'Maintenance',id:'recovery',label:'Recovery',icon:c=>`<image href="assets/icons/types/service_support/recovery.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'CBRN',id:'decontamination',label:'Decontamination',icon:c=>`<image href="assets/icons/types/support/cbrn.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Support',subcat:'Other Support',id:'meteorological',label:'Meteorological',icon:c=>`<image href="assets/icons/types/support/meteorological.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Support',subcat:'Other Support',id:'psyops',label:'PSYOPS',icon:c=>`<image href="assets/icons/types/support/psyops.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  // AVIATION
  {cat:'Aviation',subcat:'Aviation',id:'aviation',label:'Aviation',icon:c=>`<image href="assets/icons/types/aviation/aviation.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'air_cavalry',label:'Air Cavalry',icon:c=>`<image href="assets/icons/types/aviation/attack_helo.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'attack_helo',label:'Attack Helicopter',icon:c=>`<image href="assets/icons/types/aviation/attack_helo.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'attack_recon_helo',label:'Attack Recon Helicopter',icon:c=>`<image href="assets/icons/types/aviation/attack_helo.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'utility_helo',label:'Utility Helicopter',icon:c=>`<image href="assets/icons/types/aviation/aviation.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'transport_helo',label:'Transport Helicopter',icon:c=>`<image href="assets/icons/types/aviation/aviation.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'fixed_wing',label:'Fixed Wing Aircraft',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'airlift',label:'Airlift / Transport Aircraft',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'fighter',label:'Fighter Squadron',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'bomber',label:'Bomber / Strike Wing',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'cas',label:'Close Air Support',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'tanker',label:'Air Refuelling',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'airborne_c2',label:'Airborne C2 / AEW&C',icon:c=>`<image href="assets/icons/types/aviation/aviation_fixed-wing.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Aviation',subcat:'Aviation',id:'recon_uav',label:'Recon UAS',icon:c=>`<image href="assets/icons/types/support/unmanned_aerial_systems.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Aviation',subcat:'Aviation',id:'strike_uav',label:'Strike UAS',icon:c=>`<image href="assets/icons/types/support/unmanned_aerial_systems.svg" x="0" y="0" width="50" height="30"/>`},
  ...
  {cat:'Naval',subcat:'Naval',id:'riverine',label:'Riverine',icon:c=>`<path d="M10,16 L21,10 L31,10 L42,16" fill="none" stroke="${c.stroke}" stroke-width="2"/><path d="M8,24 q4,3 8,0 q4,-3 8,0 q4,3 8,0 q4,-3 8,0" fill="none" stroke="${c.stroke}" stroke-width="1.6"/>`},
  {cat:'Naval',subcat:'Naval',id:'landing_craft',label:'Landing Craft',icon:c=>`<path d="M9,19 L20,10 H34 L43,19 Z" fill="none" stroke="${c.stroke}" stroke-width="2"/><line x1="20" y1="10" x2="20" y2="19" stroke="${c.stroke}" stroke-width="1.5"/><path d="M9,24 q4,2 8,0 q4,-2 8,0 q4,2 8,0 q4,-2 8,0" fill="none" stroke="${c.stroke}" stroke-width="1.6"/>`},
  {cat:'Naval',subcat:'Naval',id:'coastal_defense_missiles',label:'Coastal Defence Missiles',icon:c=>`<image href="assets/icons/types/artillery/air_defence_missiles.svg" x="0" y="0" width="50" height="30"/>`},
  {cat:'Naval',subcat:'Naval',id:'mine_warfare',label:'Mine Warfare',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="9" font-weight="bold" fill="${c.stroke}">MCM</text>`},
  {cat:'Naval',subcat:'Naval',id:'amphibious_assault_ship',label:'Amphibious Assault Ship',icon:c=>`<path d="M8,19 L20,10 H34 L44,19 Z" fill="none" stroke="${c.stroke}" stroke-width="2"/><rect x="18" y="12" width="10" height="4" fill="none" stroke="${c.stroke}" stroke-width="1.5"/><path d="M8,24 q4,2 8,0 q4,-2 8,0 q4,2 8,0 q4,-2 8,0" fill="none" stroke="${c.stroke}" stroke-width="1.6"/>`},
  // OTHER
  ...
  {cat:'Other',subcat:'Other',id:'training',label:'Training Unit',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">TRG</text>`},
  {cat:'Other',subcat:'Other',id:'garrison',label:'Garrison',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">GAR</text>`},
...
function getSym(typeId,affil,echelon,planned=false){
  ...
  const bg=`<rect x="1" y="8" width="50" height="30" fill="#ffffffdd" stroke="rgba(0,0,0,0.12)" stroke-width="1"/>`;
  if(custom)return`<svg viewBox="0 0 52 42" xmlns="http://www.w3.org/2000/svg">${bg}${echSvg}<image x="0" y="0" width="52" height="42" href="${custom.dataUrl}" preserveAspectRatio="xMidYMid meet"/></svg>`;
...
/* ========================================
   PALETTE
======================================== */
let paletteBuildToken=0;
function buildPalette(){
  const scroll=document.getElementById('sidebar-scroll');if(!scroll)return;
  const buildToken=++paletteBuildToken;
  scroll.innerHTML='<div class="panel-help" style="padding:10px 12px">Loading unit palette...</div>';
  ...
  const sections=cats.map(cat=>{
    ...
    subcats.forEach(subcat=>{
      ...
      if(subcats.length>1) items.push({kind:'subtitle',label:subcat});
      subItems.forEach(ut=>items.push({kind:'item',ut}));
    });
  ...
  let sectionIndex=0;
  let itemIndex=0;
  function pumpPalette(deadline){
    if(buildToken!==paletteBuildToken) return;
    let budget=0;
    while(sectionIndex<sections.length){
      ...
      while(itemIndex<section.items.length){
        ...
        if(entry.kind==='subtitle'){
          ...
          subtitle.textContent=entry.label;section.grid.appendChild(subtitle);
        }else{
          const ut=entry.ut;
          ...
          item.addEventListener('dragstart',onPalDrag);section.grid.appendChild(item);
        }
        budget++;
        if((deadline&&deadline.timeRemaining&&deadline.timeRemaining()<4)||budget>=18){
          schedulePalettePump();
          return;
        }
      }
  ...
  function schedulePalettePump(){
    if('requestIdleCallback' in window){
      window.requestIdleCallback(pumpPalette,{timeout:120});
    }else{
      setTimeout(()=>pumpPalette(),0);
    }
  }
  schedulePalettePump();
}
