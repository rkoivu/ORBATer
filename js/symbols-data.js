...
const UT=[
  ...
  {cat:'Support',subcat:'Logistics',id:'ammunition',label:'Ammunition',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">AMMO</text>`},
  {cat:'Support',subcat:'Logistics',id:'fuel',label:'Fuel',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="10" font-weight="bold" fill="${c.stroke}">FUEL</text>`},
  {cat:'Support',subcat:'Logistics',id:'rations',label:'Rations',icon:c=>`<text x="25" y="20" text-anchor="middle" font-size="8" font-weight="bold" fill="${c.stroke}">RAT</text>`},
