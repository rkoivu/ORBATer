...
const UT=[
  ...
  {cat:'Combat',subcat:'Armour',id:'light_armour',label:'Light Armour',icon:c=>`<rect x="11" y="17" width="24" height="6" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="35" y1="19" x2="43" y2="16" stroke="${c.stroke}" stroke-width="2"/><circle cx="17" cy="25" r="2" fill="${c.stroke}"/><circle cx="23" cy="25" r="2" fill="${c.stroke}"/><circle cx="29" cy="25" r="2" fill="${c.stroke}"/>`},
  {cat:'Combat',subcat:'Armour',id:'tank_destroyers',label:'Tank Destroyers',icon:c=>`<rect x="10" y="18" width="20" height="5.5" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="30" y1="19" x2="43" y2="14" stroke="${c.stroke}" stroke-width="2"/><path d="M9,8 L41,22" stroke="${c.stroke}" stroke-width="2.2"/>`},
  ...
  {cat:'Fires',subcat:'Other Fires',id:'wheeled_anti_tank',label:'Wheeled Anti-Tank',icon:c=>`<path d="M8,23 H34" fill="none" stroke="${c.stroke}" stroke-width="2"/><path d="M30,18 L42,13 L37,23 Z" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="15" cy="25" r="2.4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="30" cy="25" r="2.4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M9,8 L41,22" stroke="${c.stroke}" stroke-width="2.2"/>`},
  ...
  {cat:'Support',subcat:'Maintenance',id:'recovery',label:'Recovery',icon:c=>`<image href="assets/icons/types/service_support/maintenance.svg" x="0" y="0" width="50" height="30"/>`},
...
function getSym(typeId,affil,echelon,planned=false){
  ...
  const bg=`<rect x="0" y="0" width="52" height="42" fill="#ffffffdd" stroke="rgba(0,0,0,0.12)" stroke-width="1"/>`;
