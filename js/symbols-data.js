...
const UT=[
  ...
  {cat:'Combat',subcat:'Infantry',id:'mech_inf_tracked_ifv',label:'Mechanised Infantry (Tracked IFVs)',icon:c=>`<path d="M5,5 L45,25 M45,5 L5,25" stroke="${c.stroke}" stroke-width="2.2"/><rect x="11" y="18" width="28" height="5" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="8" y1="25" x2="42" y2="25" stroke="${c.stroke}" stroke-width="2"/><circle cx="14" cy="25" r="2" fill="${c.stroke}"/><circle cx="22" cy="25" r="2" fill="${c.stroke}"/><circle cx="30" cy="25" r="2" fill="${c.stroke}"/><circle cx="38" cy="25" r="2" fill="${c.stroke}"/>`},
  {cat:'Combat',subcat:'Infantry',id:'mech_inf_wheeled_ifv',label:'Mechanised Infantry (Wheeled IFVs)',icon:c=>`<path d="M5,5 L45,25 M45,5 L5,25" stroke="${c.stroke}" stroke-width="2.2"/><rect x="11" y="17" width="28" height="5.5" rx="1.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="16" cy="25" r="2.4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="34" cy="25" r="2.4" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
  {cat:'Combat',subcat:'Infantry',id:'wheeled_mech_inf',label:'Wheeled Mechanised Infantry',icon:c=>`<path d="M5,5 L45,25 M45,5 L5,25" stroke="${c.stroke}" stroke-width="2.2"/><path d="M13,19 H37" fill="none" stroke="${c.stroke}" stroke-width="2"/><circle cx="17" cy="24" r="2.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><circle cx="33" cy="24" r="2.5" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
  // COMBAT - ARMOUR
  ...
  {cat:'Support',subcat:'Engineers',id:'pioneers',label:'Pioneers',icon:c=>`<path d="M16,10 L24,22" stroke="${c.stroke}" stroke-width="2"/><path d="M24,10 L16,22" stroke="${c.stroke}" stroke-width="2"/><path d="M28,11 L37,20" stroke="${c.stroke}" stroke-width="2"/><path d="M37,11 L28,20" stroke="${c.stroke}" stroke-width="2"/>`},
  ...
  {cat:'Support',subcat:'Engineers',id:'construction_engineers',label:'Construction Engineers',icon:c=>`<rect x="12" y="16" width="20" height="10" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M12,16 L22,10 L32,16" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><line x1="22" y1="10" x2="22" y2="26" stroke="${c.stroke}" stroke-width="1.5"/>`},
  {cat:'Support',subcat:'Engineers',id:'railway_troops',label:'Railway Troops',icon:c=>`<line x1="10" y1="26" x2="40" y2="26" stroke="${c.stroke}" stroke-width="2"/><line x1="14" y1="12" x2="14" y2="24" stroke="${c.stroke}" stroke-width="1.8"/><line x1="24" y1="12" x2="24" y2="24" stroke="${c.stroke}" stroke-width="1.8"/><line x1="34" y1="12" x2="34" y2="24" stroke="${c.stroke}" stroke-width="1.8"/>`},
  ...
  {cat:'Support',subcat:'Other Support',id:'meteorological',label:'Meteorological',icon:c=>`<path d="M11,20 q3,-6 9,-6 q2,-5 8,-5 q7,0 9,7 q6,1 6,7 q0,2 -1,3" fill="none" stroke="${c.stroke}" stroke-width="1.8"/><path d="M10,25 q5,2 10,0 q5,-2 10,0 q5,2 10,0" fill="none" stroke="${c.stroke}" stroke-width="1.8"/>`},
