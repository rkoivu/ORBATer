  ...
  function detectConflicts(){
    ...
    const FAMILY = {
      ...
      support:   ['log','supply','supply_transport','transport','ammunition','fuel',
                  'rations','ordnance','administration_sustainment','amphibious_transport','motorised_support','mechanised_support','medical','field_hospital','meteorological',
